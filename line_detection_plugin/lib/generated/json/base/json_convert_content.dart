...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<HttpDnsEntity>[] is M) {
      return data.map<HttpDnsEntity>((Map<String, dynamic> e) => HttpDnsEntity.fromJson(e)).toList() as M;
    }
    if (<LineHttpDnsModelEntity>[] is M) {
      return data.map<LineHttpDnsModelEntity>((Map<String, dynamic> e) => LineHttpDnsModelEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (HttpDnsEntity).toString(): HttpDnsEntity.fromJson,
    (LineHttpDnsModelEntity).toString(): LineHttpDnsModelEntity.fromJson,
  };
