...
export 'src/options/bubble_rtl_alignment.dart';
export 'src/options/emoji_enlargement_behavior.dart';
export 'src/models/matchers.dart';
export 'src/models/pattern_style.dart';
export 'src/options/chat_input_options.dart';
export 'src/options/typing_indicator_mode.dart';
...
export 'src/widgets/message/message_view.dart';
...
export 'src/widgets/top/top_config_option.dart';
